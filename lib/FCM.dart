...
class FCM {
  ...
  FCM() {
    ...
    var androidDetails = const AndroidNotificationDetails("TRUC-KING", "HAMZA "
        "MUAZZAM programmer", importance: Importance.max, priority: Priority.max);
      ...
      _messaging!.getToken().then((token) async {
        ...
        if (settings.authorizationStatus == AuthorizationStatus.authorized) {
          ...
          FirebaseMessaging.onMessage.listen((event) async {
            ...
            NotificationRoutes.onMessageRecived(
                event,
