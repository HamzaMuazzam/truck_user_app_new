...
class Result {
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    fleetAssigned =
        json['fleetAssigned'] != null ? new FleetAssigned.fromJson(json['fleetAssigned']) : null;
...
class VehiclePhotos {
  ...
  VehiclePhotos({this.id, this.imageUrl, this.caption, this.mimeType, this.dateCreated});
